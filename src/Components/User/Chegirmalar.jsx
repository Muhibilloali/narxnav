...
function Chegirmalar() {
  ...
  const [visibleBooksCount, setVisibleBooksCount] = useState(10); // State for pagination
  ...
  return (
    <div className="my-24 px-4 md:px-8 lg:px-12">
      <div className="title-name flex w-full pl-8 sm:w-55 text-4xl font-semibold text-center mb-8">
        {t("chegirmalar")}
      </div>

      {/* Responsive grid layout for the product cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5  gap-6 justify-items-center mt-12">
